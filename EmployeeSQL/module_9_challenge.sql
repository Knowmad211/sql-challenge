...
---IMPORT DATA---
---Make sure data is imported in same order as tables are created---
...
SELECT Department_Employee.emp_no, Department_Employee.dept_no, Departments.dept_name, Employees.last_name, Employees.first_name
